...
class TestimonialService {
    testimonialRepository = testimonialRepository; //on réutilise l'instance
    async create(data) {
        try {
    ...
    async update(id, data) {
        try {
            ...
            if (validatedData.texte !== undefined)
                dataToUpdate.text = validatedData.texte;
            ...
            if (validatedData.archive !== undefined)
                dataToUpdate.status = validatedData.archive ? TestimonialStatus.REJECTED : TestimonialStatus.APPROVED;
