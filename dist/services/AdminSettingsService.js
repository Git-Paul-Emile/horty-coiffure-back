...
class AdminSettingsService {
    adminSettingsRepository = adminSettingsRepository; //on réutilise l'instance
    async create(data) {
        try {
    ...
    async update(id, data) {
        try {
            ...
            const dataToUpdate = {};
            if (validatedData.horairesOuverture !== undefined)
                dataToUpdate.openingHours = validatedData.horairesOuverture;
            if (validatedData.infoContact !== undefined)
                dataToUpdate.contactInfo = validatedData.infoContact;
            if (validatedData.parametresHero !== undefined)
                dataToUpdate.heroSettings = validatedData.parametresHero;
            if (validatedData.liensSociaux !== undefined)
                dataToUpdate.socialLinks = validatedData.liensSociaux;
